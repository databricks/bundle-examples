...
- `common/third_party_sinks/` - 3P observability integration (Datadog, New Relic Splunk, Azure Monitor). See `README-third-party-monitoring.md` for details.
- `common/vars/` - DAB variables for the shared resources customization
