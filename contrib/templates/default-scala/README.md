...
This template helps you create Scala projects with Declarative Automation Bundles (DABs). It uses sbt to compile and package Scala files, and can be used with Databricks Connect for local development.
