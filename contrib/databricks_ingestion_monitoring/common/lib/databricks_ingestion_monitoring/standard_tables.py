...
class MonitoringTable:
  ...
  """
  def __init__(self, name: str, table_type: TableType, table_comment:str, column_comments: Optional[Dict[str, str]] = None):
    """
    Constructor
    ...
    self.log = logging.getLogger(f"databricks_ingestion_monitoring.MonitoringTable.{self.name}")

  def add_column_comments(self, monitoring_catalog: str, monitoring_schema: str, spark: SparkSession):
    """
    ...
    for column_name, column_comment in self.column_comments.items():
      if column_name in table_column_names:
        ...
        comment_sql=" ".join([p.replace("'","''") for p in column_comment_parts])
...
EVENTS_ERRORS = MonitoringTable(
  ...
  column_comments={
      ...
      "pipeline_run_id": STANDARD_COLUMN_COMMENTS["pipeline_run_id"],
      "pipeline_run_link": STANDARD_COLUMN_COMMENTS["pipeline_run_link"],
      "table_name": STANDARD_COLUMN_COMMENTS["table_name"] + " affected by the error (if any)",
      "flow_name": STANDARD_COLUMN_COMMENTS["flow_name"],
      "event_timestamp": STANDARD_COLUMN_COMMENTS["event_timestamp"],
...
EVENTS_WARNINGS = MonitoringTable(
  ...
  column_comments={
      ...
      "pipeline_run_id": STANDARD_COLUMN_COMMENTS["pipeline_run_id"],
      "pipeline_run_link": STANDARD_COLUMN_COMMENTS["pipeline_run_link"],
      "table_name": STANDARD_COLUMN_COMMENTS["table_name"] + " affected by the warning (if any)",
      "flow_name": STANDARD_COLUMN_COMMENTS["flow_name"],
      "event_timestamp": STANDARD_COLUMN_COMMENTS["event_timestamp"],
...
PIPELINES_STATUS = MonitoringTable(
  ...
  column_comments={
      ...
      "latest_pipeline_run_state": STANDARD_COLUMN_COMMENTS["latest_state"] % ('latest'),
      "latest_pipeline_run_state_color": STANDARD_COLUMN_COMMENTS["state_color"] % ('latest'),
      "latest_pipeline_run_state_with_color": STANDARD_COLUMN_COMMENTS["latest_state_with_color"] % ('latest'),
      "latest_pipeline_run_state_level": STANDARD_COLUMN_COMMENTS["latest_state_level"] % ('latest'),
      "latest_pipeline_run_create_time": STANDARD_COLUMN_COMMENTS["create_time"] % ('latest'),
      "latest_pipeline_run_end_time": STANDARD_COLUMN_COMMENTS["end_time"] % ('latest'),
      "latest_pipeline_run_is_complete": STANDARD_COLUMN_COMMENTS["is_complete"] % ('latest'),
      "latest_error_log_message": STANDARD_COLUMN_COMMENTS["latest_error_log_message"] % ('latest'),
      "latest_error_message": STANDARD_COLUMN_COMMENTS["latest_error_message"] % ('latest'),
      ...
      "latest_successful_run_create_time": STANDARD_COLUMN_COMMENTS["create_time"] % ('successful'),
      "latest_successful_run_end_time": STANDARD_COLUMN_COMMENTS["end_time"] % ('successful'),
      ...
      "latest_failed_run_create_time": STANDARD_COLUMN_COMMENTS["create_time"] % ('failed'),
      "latest_failed_run_end_time": STANDARD_COLUMN_COMMENTS["end_time"] % ('failed'),
      "latest_failed_run_error_log_message": STANDARD_COLUMN_COMMENTS["latest_error_log_message"] % ('failed'),
      "latest_failed_run_error_message": STANDARD_COLUMN_COMMENTS["latest_error_message"] % ('failed'),
      "latest_failed_run_error_code": STANDARD_COLUMN_COMMENTS["latest_error_code"] % ('failed'),
      "updated_at": "Timestamp of latest update (based on the event log timestamp) applied to this row",
...
TABLE_STATUS_PER_PIPELINE_RUN = MonitoringTable(
  ...
  column_comments={
      ...
      "latest_error_time": STANDARD_COLUMN_COMMENTS["latest_table_error_time"] % ('this'),
      "latest_error_log_message": STANDARD_COLUMN_COMMENTS["latest_table_error_log_message"] % ('this'),
      "latest_error_message": STANDARD_COLUMN_COMMENTS["latest_table_error_message"] % ('this'),
      "latest_error_full": STANDARD_COLUMN_COMMENTS["latest_table_error_full"] % ('this'),
      "flow_type": STANDARD_COLUMN_COMMENTS['flow_type'],
      ...
      "latest_state_with_color": STANDARD_COLUMN_COMMENTS['latest_table_state_with_color'],
  }
)
...
TABLE_STATUS = MonitoringTable(
  ...
  column_comments={
      ...
      "latest_state_color": STANDARD_COLUMN_COMMENTS['latest_table_state_color'],
      "latest_state_with_color": STANDARD_COLUMN_COMMENTS['latest_table_state_with_color'],
      "latest_table_schema_json": STANDARD_COLUMN_COMMENTS["table_schema_json"] % ('the latest'),
      "latest_table_schema": STANDARD_COLUMN_COMMENTS["table_schema"] % ('the latest'),
      ...
      "latest_error_time": STANDARD_COLUMN_COMMENTS["latest_table_error_time"] % ('a'),
      "latest_error_log_message": STANDARD_COLUMN_COMMENTS["latest_table_error_log_message"] % ('a'),
      "latest_error_message": STANDARD_COLUMN_COMMENTS["latest_table_error_message"] % ('a'),
      "latest_error_full": STANDARD_COLUMN_COMMENTS["latest_table_error_full"] % ('a'),
...
def set_all_table_column_comments(monitoring_catalog: str, monitoring_schema: str, spark: SparkSession):
  for st in [MONITORED_PIPELINES, MONITORED_TABLES, EVENT_LOGS_BRONZE, PIPELINE_RUNS_STATUS, EVENTS_ERRORS,
             EVENTS_WARNINGS, METRIC_PIPELINE_HOURLY_ERROR_RATE, PIPELINES_STATUS_SILVER, PIPELINES_STATUS,
             EVENTS_TABLE_METRICS, TABLE_STATUS_PER_PIPELINE_RUN, TABLE_STATUS,
             TABLE_EVENTS_EXPECTATION_CHECKS, PIPELINE_TAGS_INDEX]:
