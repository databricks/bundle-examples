...
def create_dlt_table(
    ...
    Args:
        ...
        expectations (Dict[str, str], optional): Dictionary of expectation name to SQL expression
    ...
    # Apply additional expectations if provided
    if expectations:
        table_function = dlt.expect_all_or_drop(expectations)(table_function)
