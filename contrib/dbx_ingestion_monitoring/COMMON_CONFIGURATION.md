...
See [vars/import_event_logs.vars.yml](vars/import_event_logs.vars.yml) for detailed configuration variable descriptions.
...
See [vars/pipeline_tags_index.vars.yml](vars/pipeline_tags_index.vars.yml) for detailed configuration variable descriptions.
