...
* If you're using the CLI, use `databricks bundle run lakeflow_pipelines_python_etl --refresh sample_trips_lakeflow_pipelines_python` to run a single transformation.
