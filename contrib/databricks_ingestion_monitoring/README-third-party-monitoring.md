...
- If additional scope/parameters are required for fetching oauth2 tokens, please update the payload in databricks_ingestion_monitoring_pkg/third_party_sinks/azuremonitor_sink.py fetch_access_token() function.
