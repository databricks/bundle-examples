...
* If you're using the CLI, use `databricks bundle run lakeflow_pipelines_sql_etl --refresh sample_trips_lakeflow_pipelines_sql` to run a single transformation.
